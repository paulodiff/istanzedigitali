...
.controller('ListReportController', 
  ...
  $log.debug('ListReportController>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');                                 
  $log.debug('ListReportController start...');
  ...
  $ionicModal.fromTemplateUrl('templates/reportOptionsModal.html', 
        function(sortModal) {
  ...
  $scope.openSortModal = function() {
        $log.debug('ListReportController Sort Modal ...');    
        $scope.sortModal.show();
  };
                                 
  $scope.openDetailModal = function(item) {
        $log.debug('ListReportController Detail Modal ... :');    
        $log.debug(item);
  ...
  $log.debug('ListReportController SERVIZI INIT filterCriteria');
  $log.debug($scope.filterCriteria);
  ...
  $scope.fetchResult = function () {
      $log.debug('ListReportController: fetchResult');
      $log.debug('ListReportController: impostazione criteri di filtro');
      ...
      $log.debug($scope.filterCriteria);
      $log.debug('ListReportController...fetchResult - GET Count');

      var serviziList = Restangular.all('getReport');
      
      // Get items ...  
      $log.debug('ListReportController...fetchResult - GET data ... .... .... ');
  ...
  $scope.selectPage = function () {
    ...
    $log.debug('ListReportController: SELECT PAGE ...');  
    $log.debug('ListReportController: Page changed to: ' + $scope.currentPage);  
    $log.debug('ListReportController...selectPage:' + page);
  ...
  $log.debug('ListReportController : selectPage 1');
