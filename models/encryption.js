...
var joinUnit8Arrays = (allUint8Arrays) => {
    ...
    .then((encryptedPayloadArrayBuffer) => {
      ...
      .then((keys) => {
        return {
          ...
          salt: this.uint8ArrayToBase64Url(this.getSalt()),
          publicServerKey:  this.uint8ArrayToBase64Url(keys.publicKey),
        };
      });
    });
  }
...
function sendPushMessage(subscription, payloadText) {
    ...
    .then((results) => {
      ...
      if (subscription.endpoint.indexOf(
        ...
        infoFunction = () => {
          return this.getGCMInfo(subscription, payload, this._API_KEY);
        };
      }
...
exports.EncryptionHelperFactoryWrapper = function(){
    console.log('EncryptionHelperFactoryWrapper');
    console.log(EncryptionHelperFactory.generateHelper());
    return EncryptionHelperFactory.generateHelper();
};

exports.sendPushMessage = function(subscription, payloadText){
