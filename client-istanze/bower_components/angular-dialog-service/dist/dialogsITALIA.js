...
angular.module('dialogs.main',['dialogs.services','ngSanitize']) // requires angular-sanitize.min.js (ngSanitize) //code.angularjs.org/1.2.1/angular-sanitize.min.js
	...
	.config(['$translateProvider','dialogsProvider',function($translateProvider,dialogsProvider){
		...
		try{
			...
			$translateProvider.translations('en-US',{
	            ...
	            DIALOGS_ERROR_MSG: "Attenzione errore applicazione.",
	...
	.run(['$templateCache','$interpolate',function($templateCache,$interpolate){
		...
		//$templateCache.put('/dialogs/error.html','<div class="Dialog js-fr-dialogmodal u-color-grey-90 u-background-red" id="modal"><div class="modal-header dialog-header-error u-color-grey-90"><button type="button" class="close" ng-click="close()">&times;</button><h4 class="modal-title u-cf u-text-h2 u-borderHideFocus"><span class="'+startSym+'icon'+endSym+'"></span> <span ng-bind-html="header"></span></h4></div><div class="modal-body text-danger Prose" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="Button Button--danger js-fr-dialogmodal-close u-floatRight" ng-click="close()">'+startSym+'"DIALOGS_CLOSE" | translate'+endSym+'</button></div></div>');
		$templateCache.put('/dialogs/error.html','<div class="Dialog js-fr-dialogmodal u-color-grey-90 u-background-red" id="modal"><div class="modal-header dialog-header-error u-color-grey-90"><button type="button" class="close" ng-click="close()">&times;</button><h4 class="modal-title u-cf u-text-h2 u-borderHideFocus"><span ng-bind-html="header"></span></h4></div><div class="modal-body text-danger Prose" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="Button Button--danger js-fr-dialogmodal-close u-floatRight btn-block" ng-click="close()">'+startSym+'"DIALOGS_CLOSE" | translate'+endSym+'</button></div></div>');
		...
		//$templateCache.put('/dialogs/notify.html','<div class="modal-header dialog-header-notify"><button type="button" class="close" ng-click="close()" class="pull-right">&times;</button><h4 class="modal-title text-info"><span class="'+startSym+'icon'+endSym+'"></span> '+startSym+'header'+endSym+'</h4></div><div class="modal-body text-info" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="Button Button--default js-fr-dialogmodal-close btn-block" ng-click="close()">'+startSym+'"DIALOGS_OK" | translate'+endSym+'</button></div>');
		$templateCache.put('/dialogs/notify.html','<div class="Dialog js-fr-dialogmodal u-color-grey-90 u-background-red" id="modal"><div class="modal-header dialog-header-error u-color-grey-90"><button type="button" class="close" ng-click="close()">&times;</button><h4 class="modal-title u-cf u-text-h2 u-borderHideFocus"><span ng-bind-html="header"></span></h4></div><div class="modal-body text-danger Prose" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="Button Button--default js-fr-dialogmodal-close u-floatRight btn-block" ng-click="close()">'+startSym+'"DIALOGS_CLOSE" | translate'+endSym+'</button></div></div>');
