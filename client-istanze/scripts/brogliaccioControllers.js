...
//EditItemCtrl--------------------------------------------------------------------------------------
//EditItemCtrl--------------------------------------------------------------------------------------
.controller('EditItemBrogliaccioController', 
...
.controller('ListBrogliaccioController', 
  ...
  $log.debug('ListBrogliaccioController>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');                                 
  $log.debug('ListBrogliaccioController start...');
  ...
  $scope.openSortModal = function() {
        $log.debug('ListBrogliaccioController Sort Modal ...');    
        $scope.sortModal.show();
  };
                                 
  $scope.openDetailModal = function(item) {
        $log.debug('ListBrogliaccioController Detail Modal ... :');    
        $log.debug(item);
  ...
  $scope.saveSort = function() {
    $log.debug("ListBrogliaccioController: SORT MODAL " + this.filterTerm + " sort " + this.sortBy + ' id_selezione :' + this.id_utenti_selezione);
  ...
  $scope.OpenFilter = function() {
       $log.debug("ListBrogliaccioController: OpenFilter .. sortModal.show()");
       $scope.sortModal.show();
  };                                 
  ...
  $scope.fetchResult = function () {
      $log.debug('ListBrogliaccioController: fetchResult');
      $log.debug('ListBrogliaccioController: impostazione criteri di filtro');
      ...
      $log.debug($scope.filterCriteria);
      $log.debug('ListBrogliaccioController...fetchResult - GET Count');
    

      var serviziList = Restangular.all('getBrogliaccio');
      
      // Get items ...  
      $log.debug('ListBrogliaccioController...fetchResult - GET data');
  ...
  $scope.selectPage = function () {
    ...
    $log.debug('ListBrogliaccioController: SELECT PAGE ...');  
    $log.debug('ListBrogliaccioController: Page changed to: ' + $scope.currentPage);  
    $log.debug('ListBrogliaccioController...selectPage:' + page);
  ...
  $log.debug('ListBrogliaccioController : selectPage 1');
