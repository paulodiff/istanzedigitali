angular.module('myApp.controllers')
  ...
  .controller('queueMgrCtrl', 
           ...
           ['$scope', '$http', 'dialogs',  '$rootScope', 'AuthService', 'QueueService', '$state','ENV', '$log','usSpinnerService',
    function($scope,   $http,  dialogs,     $rootScope,   AuthService,   QueueService, $state,  ENV ,  $log, usSpinnerService ) {
