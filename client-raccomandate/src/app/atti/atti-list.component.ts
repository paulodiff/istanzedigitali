...
stampaReport() {
  ...
  elencoTabellare.push([ 'Progr.', 'Data', 'Nominativo', 'Cronologico' , 'Protocollo', 'Destinatario',  'Firma', 'Progr' ]);
  tableWidhts =        [ 50,    60,        'auto',       'auto',         'auto',       '*',             '*',      60 ];

  this.items.forEach(function(obj){
    elencoTabellare.push([
          {text: obj.id, fontSize: 10, border: [true, false, false, false]},
          {text: moment(obj.atti_data_reg).format('DD/MM/YYYY'), fontSize: 10,border: [false, true, false, true]},
          {text: obj.atti_nominativo, fontSize: 10, border: [true, false, false, true]},
          {text: obj.atti_cronologico, fontSize: 10, border: [false, true, false, false]},
          {text: obj.atti_note, fontSize: 10, border: [true, true, false, false]},
          {text: obj.atti_note, fontSize: 10, border: [false, true, false, false]},
          {text: obj.atti_operatore, fontSize: 10},
          {text: obj.id, fontSize: 10, alignment: 'right'}
    ]);

    elencoTabellare.push([
      { text: obj.atti_consegnatario + '/' + obj.atti_cronologico, colSpan: 2, alignment: 'left', border: [true, false, false, true]},
      { text: 'Header 3', colSpan: 2, alignment: 'center'},
      {},{},{},{},{},{}
    ]);
  });
  ...
  contenutoStampa.push( { text: 'Comune di Rimini - Ufficio Protocollo - DEPOSITO ATTI COMUNALI - data deposito: ' + moment().format('DD/MM/YYYY'), fontSize: 18 } );
  ...
  //contenutoStampa.push( { text: 'Gestione Posta del ' + moment().format('DD/MM/YYYY'), fontSize: 12 } );
  //contenutoStampa.push( { text: 'Tipo Posta : ' + 'TIPO', fontSize: 12 } );
  contenutoStampa.push( tabellaStampa );

  contenutoStampa.push({ text: 'Totale: ' + '99999', fontSize: 12, bold: true, margin: [0, 0, 0, 8] });
